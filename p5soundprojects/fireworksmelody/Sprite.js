let minorBluesScale = [0,0,0,261.63,311.13,349.23,369.99,392.00,466.16,523.25,622.25,698.46,0,0,0];
let GRAVITY = 0.1;
...
class Sprite{
  ...
  play(){
    ...
    osc.freq(minorBluesScale[index], 0.05);
    osc.amp(0.5, 0.2);
    stopSound = frameCount+sixteenth*2;
    playing = true;
  }
  ...
  update(){
    ...
    if(this.y - this.size/2 <= 0){
      ...
      this.yspeed = -abs(this.yspeed+random(-1,2))
    }
  }
